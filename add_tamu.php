...
<body>
  ...
  <div class="container">
    ...
    <center><h1> Daftar</h1></center>
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" method="post" action="insert_tamu.php" novalidate>
  ...
  <div class="col-md-4 position-relative">
    ...
    <div class="input-group has-validation">
      ...
      <input type="email" class="form-control" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="Masukkan Email Anda" name="email"required>
  ...
  <div class="col-md-6 position-relative">
    <label for="validationTooltip03" class="form-label">Asal Sekolah</label>
     <select class="form-select" id="validationTooltip04" name="asalsekolah" required>
      <option selected disabled value="">Masukkan Asal Sekolah</option>
